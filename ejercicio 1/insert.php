<?php
	...
	// var_dump($_POST);
	/*
		El var_dump() imprime el array del $_POST completo algo como

		array(4) { ["cedula"]=> string(8) "27686483" ["nombre"]=> string(6) "Nelson" ["apellido"]=> string(8) "Portillo" ["sexo"]=> string(9) "Masculino" }

		cuando decimos $_POST['cedula'] estamos entrando al valor de la cedula unicamente que seria (27686483)
